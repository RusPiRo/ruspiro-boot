...
## Usage
To use this crate simply add the following lines to the Crate.toml file:
```
[dependencies]
...
To successfully link this crate it is highly recomended to use the linker script [link.ld] for this step. This file defines all the necessary linker sections and symbols to allow
this crate taking responsibility on the whole boot sequence of the Raspberry Pi in 32bit baremetal mode.
